...
function ChargesExplanation() {
  return (
    <div className="container my-5 col-lg-9 mx-md-auto">
      ...
      <div className="row text-muted">
        <div className="col-md-6">
          ...
          <p className="fs-6">
            When trading at EquiTrade, STT/CTT can be a lot more than the
          ...
          <p className="fs-6">
            ...
            dealer at EquiTrade including auto square off orders.
          </p>
        ...
        <div className="col-md-6">
          ...
          <p className="fs-6">
            ₹15.34 per scrip (₹3.5 CDSL fee + ₹9.5 EquiTrade fee + ₹2.34 GST) is
          ...
          <p className="fs-6">₹30 + GST per pledge request per ISIN.</p>
          ...
          <p className="fs-6">₹25 per transaction.</p>
